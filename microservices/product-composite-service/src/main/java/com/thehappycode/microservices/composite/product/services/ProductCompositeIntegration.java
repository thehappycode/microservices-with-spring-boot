...
import com.thehappycode.api.core.recommendation.RecommendationService;
...
import com.thehappycode.util.http.HttpErrorInfo;
...
public class ProductCompositeIntegration implements ProductService, RecommendationService, ReviewService {
    ...
    public List<Recommendation> getRecommendations(int productId) {
        try {
            ...
            LOG.debug("Found {} recommendation for a proudct with id {}", recommendations.size(), productId);
